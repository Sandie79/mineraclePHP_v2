...
<body>
    ...
    <main>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col" id="hero_accueil">
                    <h1 class="mx-auto">Mes informations</h1>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="shadow-lg p-3 mb-5 bg-body-tertiary rounded text-center my-5" style="font-size:2.5rem; font-weight:bold">Modifier mes informations</div>
            </div>
        </div>
